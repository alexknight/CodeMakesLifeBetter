...
def run_with_driver():
    ...
    os.remove('pic.png')
    user = manager.driver.find_element(By.ID, 'username_personal').send_keys('Jialing0321')
    passwd = manager.driver.find_element(By.ID, 'password_personal').send_keys('TBXWlsf1995')
